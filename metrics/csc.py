...
def compute_csc(nodes: Dict[str, EvalNode], root_id: str, model_name: str, batch_size: int, text_source: str = "auto") -> Dict:
    ...
    vecs = embedder.encode([semantic_text(n, text_source=text_source) for n in kept], batch_size=batch_size, show_progress_bar=False)
