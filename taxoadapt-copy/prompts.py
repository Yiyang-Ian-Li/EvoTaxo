...
dimension_definitions = {
    'taxonomy': """Taxonomy: organizes and categorizes content into a hierarchical structure of topics and subtopics, enabling systematic classification and organization of discussions, posts, or documents based on their main themes and subject matter.""",
...
node_dimension_definitions = {
    'taxonomy': """Defines and categorizes topics and themes within a domain, organizing content into hierarchical structures that capture the main subjects, discussions, and areas of focus.""",
